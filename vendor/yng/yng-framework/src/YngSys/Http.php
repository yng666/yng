...
class Http
{
    ...
    protected function runWithRequest(Request $request)
    {
        ...
        return $this->app->middleware->pipeline()->send($request)
    ...
    {
        if (is_file($this->app->getConfigPath() . 'middleware.php')) {
            $this->app->middleware->import(include $this->app->getConfigPath() . 'middleware.php');
        }
    }
